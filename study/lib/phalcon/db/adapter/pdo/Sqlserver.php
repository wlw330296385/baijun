...
/**
 * Phalcon\Db\Adapter\Pdo\Sqlserver
 * Specific functions for the SQL Server database system
 * <code>
 * $config = array(
 * "host" => "192.168.0.11",
 * "dbname" => "blog",
 ...
 * "password" => "secret"
 * );
 * $connection = new \Phalcon\Db\Adapter\Pdo\Sqlserver($config);
 * </code>.
 *
 * @property \Phalcon\Db\Dialect\Sqlserver $_dialect
 */
class Sqlserver extends \Phalcon\Db\Adapter\Pdo implements \Phalcon\Db\AdapterInterface
{

    protected $_type = 'sqlsrv';
    protected $_dialectType = 'sqlserver';
